#include "header.h"
////////////////////////////////////////////////////////////////////////
///Sous programme pour sauvegarder le compteur de joueur en faillite////
////////////////////////////////////////////////////////////////////////

void sauvegardeCompteurFaillite(int compteurfaillite)
{
    ///Ouverture et test d'ouverture du fichier
    FILE* cmpfaillite = fopen("fichiersSauvegarde/cmpFaillite.bin", "wb+");
    if (cmpfaillite == NULL)
    {
    ...
    fwrite(&compteurfaillite,sizeof(int),1,cmpfaillite);
...
////////////////////////////////////////////////////////////////////////
///Sous programme pour charger le compteur de joueur en faillite////////
////////////////////////////////////////////////////////////////////////

void chargerNmbrJoueurFaillite(int compteurF)
{
    ///Ouverture et test d'ouverture du fichier
    FILE* cmptFaillite = fopen("fichiersSauvegarde/cmpFaillite.bin", "rb");
    if (cmptFaillite == NULL)
    {
    ...
    fread(&compteurF,sizeof(int),1,cmptFaillite);
